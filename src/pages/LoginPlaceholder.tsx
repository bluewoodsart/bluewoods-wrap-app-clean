    ...
    <div className="min-h-screen bg-slate-950 px-5 py-6 text-white">
      <div className="mx-auto flex max-w-3xl flex-col gap-10">
        ...
        <main className="rounded-lg border border-white/15 bg-white/10 p-6 shadow-2xl md:p-10">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-cyan-200">Portal access</p>
          <h1 className="mt-4 text-4xl font-black leading-tight md:text-5xl">Staff and sales rep login coming soon.</h1>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-200">
            The public quote tools are live now. Staff portal access will be added in a later protected phase.
          </p>
